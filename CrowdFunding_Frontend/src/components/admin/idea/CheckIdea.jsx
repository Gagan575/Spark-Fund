...
/>
                                    ...
                                    <div className="d-flex align-items-center gap-4 mt-3">
                                        ...
                                        :
                                        <Link to={`/login`} className="btn btn-primary py-3 px-5 rounded-pill ms-auto">Login</Link>
                ...
                >
                    ...
                    >
                        <div className="modal-content rounded">
                            <div className="modal-header">
                                <h5 className="modal-title">View Comment</h5>
                                <button
                                    type="button"
                                    className="btn-close"
                                    onClick={() => setShowCommentModal(false)}
                                    ...
                                    {(comments || [])
                                        ...
                                        .map((c, i) => (
                                            <div key={i} className="mb-3 p-2 border rounded">
                                                <small className="text-dark">{c.userId?.name || "User"}</small>
